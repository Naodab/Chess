...
public class Board {
    ...
    public static Board createByFEN(String fen) {
        ...
        builder.setMoveMaker(Alliance.WHITE);
        if (info[1].equals("b")) builder.setMoveMaker(Alliance.BLACK);
    ...
    public String calculateCanCastle(final Collection<Piece> pieces, final Alliance alliance) {
        ...
        for (Piece piece : whitePieces) {
            ...
            if (piece.getPieceType().isRook() && piece.isFirstMove()) {
                if (piece.getPiecePosition() == 0 || piece.getPiecePosition() == 56) rookQueenSideCanCastle = true;
                else rookKingSideCanCastle = true;
            }
        }
    ...
    public String generateFen() {
        ...
        for (int i = 0; i < BoardUtils.NUM_TILES; i++) {
            ...
            if ((i + 1) % BoardUtils.NUM_TILES_PER_ROW == 0) {
                ...
                if (i != BoardUtils.NUM_TILES - 1) builder.append("/");
            }
        }
        ...
        if (this.getEnPassantPawn() != null) {
            builder.append(BoardUtils.getPositionAtCoordinate(
                            this.getEnPassantPawn().getPiecePosition()))
                    .append(" ");
        } else {
            builder.append("- ");
        }
