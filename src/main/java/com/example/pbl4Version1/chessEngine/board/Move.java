...
public abstract class Move {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(board, other.board)
                && destinationCoordinate == other.destinationCoordinate
    ...
    public static final class MajorAttackMove extends AttackMove {
        public MajorAttackMove(
                final Board board, final Piece movedPiece, final int destinationCoordinate, final Piece pieceAttacked) {
    ...
    public static class AttackMove extends Move {
        ...
        public AttackMove(
                final Board board, final Piece movedPiece, final int destinationCoordinate, final Piece attackedPiece) {
            super(board, movedPiece, destinationCoordinate);
    ...
    static class CastleMove extends Move {
        ...
        public int hashCode() {
            final int prime = 31;
            int result = super.hashCode();
            result = prime * result + Objects.hash(castleRook, castleRookDestination, castleRookStart);
            return result;
        }
