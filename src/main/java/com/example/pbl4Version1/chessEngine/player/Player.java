...
public abstract class Player {
    ...
    Player(final Board board, final Collection<Move> legalMoves, final Collection<Move> opponentMoves) {
        ...
        this.isInCheck = !Player.calculateAttacksOnTile(this.playerKing.getPiecePosition(), opponentMoves)
                .isEmpty();
    }
    ...
    public static Collection<Move> calculateAttacksOnTile(int coordinate, Collection<Move> opponentMoves) {
        ...
        for (final Move move : opponentMoves) {
            if (coordinate == move.getDestinationCoordinate()) attackMoves.add(move);
        }
