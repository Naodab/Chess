...
//	private static final Rank ADVANCED = new Rank("Advanced", 1400, 1699);
//	private static final Rank EXPERT = new Rank("Expert", 1700, 1999);
//	private static final Rank CANDIDATE_MASTER = new Rank("Candidate master", 2000, 2199);
...
//		ranks.add(BEGINNER);
//		ranks.add(AMATEUR);
//		ranks.add(INTERMEDIATE);
//		ranks.add(ADVANCED);
//		ranks.add(EXPERT);
//		ranks.add(CANDIDATE_MASTER);
//		ranks.add(FIDE_MASTER);
